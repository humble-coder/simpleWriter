...
config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/:username/messages', {templateUrl: './partials/messages.html', controller: 'messagesCtrl'});
  $routeProvider.when('/:username/new-message', {templateUrl: './partials/new-message.html', controller: 'newMessageCtrl'});
