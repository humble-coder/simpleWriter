...
config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/messages/new-message', {templateUrl: '../partials/new-message.html', controller: 'newMessageCtrl'});
  $routeProvider.when('/messages/:username', {templateUrl: '../partials/messages.html', controller: 'messagesCtrl'});
